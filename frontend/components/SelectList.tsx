...
export default function SelectList({
  ...
  const selectorClasses = `relative min-w-[180px] h-[40px] p-[12px] pt-[16px] flex items-center justify-start border border-stroke-light rounded-[4px] hover:bg-hover-light hover:text-typo-dark cursor-pointer ${selectorCustomClasses} ${isOpen ? 'bg-hover-light' : ''}`;

  const dropdownClasses = () => {
    return `absolute min-w-[180px] mt-[2px] bg-[#333] z-50 rounded shadow-md select-none border ${menuCustomClasses}`;
  };
